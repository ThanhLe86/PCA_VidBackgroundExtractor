...
if __name__ == "__main__":
    csv_file = "background_output.csv"  # Replace with your actual CSV filename
    ...
    try:
        ...
        reconstruct_frames_from_transposed_csv(csv_file, output_dir, frame_numbers=[0, 1, 2, 3, 4], header='V')
